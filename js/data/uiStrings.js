...
const UI = {
  ...
  results: {
    ...
    newAliens: 'אָסַפְתָּ חַיְזָרִים חֲדָשִׁים!',
  ...
  startOver: {
    button: '🏠',
    title: 'לַחֲזוֹר לַתַּפְרִיט?',
    message: 'תַּחֲזְרוּ לַתַּפְרִיט הָרָאשִׁי',
    confirm: 'כֵּן, לַתַּפְרִיט',
    cancel: 'לֹא, לְהַמְשִׁיךְ לְשַׂחֵק',
  },
